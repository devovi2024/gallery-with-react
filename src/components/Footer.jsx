...
const Footer = () => {
  return (
    <footer
      className="w-full py-8 px-4 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white"
      style={{
    ...
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10">
        ...
        <div className="text-center sm:text-left">
          <h2 className="text-3xl font-bold mb-4">AuctionGallery</h2>
        ...
        <div className="text-center sm:text-left">
          ...
          <ul className="text-sm space-y-2">
            ...
            <li><a href="#about" className="hover:text-gray-300">How it works</a></li>
        ...
        <div className="text-center sm:text-left">
          ...
          <ul className="text-sm space-y-2">
            <li>Email: contact@AuctionGallery.com</li>
